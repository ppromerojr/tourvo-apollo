...
/******/ 	var installedChunks = {
/******/ 		"static/development/pages/_document.js": 0
/******/ 	};
/******/
...
/* harmony import */ var apollo_client__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! apollo-client */ "apollo-client");
/* harmony import */ var apollo_client__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(apollo_client__WEBPACK_IMPORTED_MODULE_11__);
    ...
    WithApollo.getInitialProps = async ctx => {
      ...
      if (true) {
        ...
        if (ssr) {
          ...
          next_head__WEBPACK_IMPORTED_MODULE_9___default.a.rewind();
        }
...
function createApolloClient(initialState = {}) {
  ...
  return new apollo_client__WEBPACK_IMPORTED_MODULE_11__["ApolloClient"]({
    ssrMode: true,
    // Disables forceFetch on the server (so queries are only run once)
    link: new apollo_link_http__WEBPACK_IMPORTED_MODULE_13__["HttpLink"]({
      uri: GRAPHQL_URL,
      // Server URL (must be absolute)
      credentials: 'same-origin',
      // Additional fetch() options like `credentials` or `headers`
      fetch: (isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_14___default())
    }),
    cache: new apollo_cache_inmemory__WEBPACK_IMPORTED_MODULE_12__["InMemoryCache"]().restore(initialState)
  });
}
